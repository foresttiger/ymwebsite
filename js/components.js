  ...
  function renderOrderTable(data, type) {
      ...
      layui.use('table', function() {
          ...
          table.render({
              ...
              cols: [
                  [ //标题栏
                      { field: 'userId', title: 'ID', width: 80, sort: true, align: "center",fixed: 'left' },
                      { field: 'cellname', title: '项目名称', sort: true, templet: '#cellnameTpl' },
                      { field: 'address', title: '楼层号', align: "center" },
                      { field: 'components', title: '构件名称', align: "center" },
                      { field: 'area', title: '尺寸', align: "center" },
                      { field: 'style', title: '混凝土方量', align: "center" },
                      { field: 'type', title: '构件重量', sort: true, align: "center" },
                      { field: 'budget', title: '混凝土等级', align: "center" },
                      { field: 'price', title: '生成日期', align: "center" },
                      { field: 'name', title: '状态', sort: true, align: "center" },
                      { field: 'mobilephone', title: '车辆', sort: true, align: "center" },
                      { field: 'other', title: '出库', sort: true },
                      { field: 'date', title: '日期', sort: true, align: "center" },
                      { field: 'status', title: '状态', sort: true, align: "center", templet: '#statusTpl' },
